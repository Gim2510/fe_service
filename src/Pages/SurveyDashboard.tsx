...
export function SurveyDashboard() {
    ...
    return (
        <main className={`min-h-screen ${isDark ? "bg-[#060D1B] text-white" : "bg-[#F8FAFC] text-slate-900"}`}>
                        ...
                        <button
                            ...
                            className={`inline-flex items-center gap-1.5 px-4 py-2 rounded-xl text-xs font-medium
                                ...
                                ${activeTab === tab.id
                                    ...
                                    : isDark
                                        ? "border-blue-900/20 text-slate-500 hover:text-slate-300 hover:border-blue-900/40"
                                            ...
                                            <div key={index} className={`rounded-2xl border overflow-hidden ${card}`}>
                                                ...
                                                >
                                                    <div className="flex items-center gap-4">
                                                        <span className={`font-mono text-xs ${isDark ? "text-blue-600" : "text-blue-400"}`}>
                                                ...
                                                <AnimatePresence>
                                                    {isOpen && (
                                                        ...
                                                        >
                                                            <div className={`px-6 pb-6 space-y-5 border-t ${isDark ? "border-blue-900/20" : "border-slate-100"}`}>
                                                                ...
                                                                <p className={`text-xs pt-3 border-t ${isDark ? "border-blue-900/20 text-slate-500" : "border-slate-100 text-slate-400"}`}>
                                                                    {detail.outcome}
                                                                </p>
                                                            </div>
                                                        </motion.div>
                            ...
                            {activeTab === "answers" && (
                                <div className="space-y-5">
                                            ...
                                            <button
                                                ...
                                                className={`w-8 h-8 rounded-lg text-xs font-mono font-semibold border transition-colors shrink-0
                                                    ${currentIndex === idx
                                                        ...
                                                        : isDark ? "border-blue-900/20 text-slate-500 hover:text-slate-300" : "border-slate-200 text-slate-500 hover:bg-slate-50"
                                                    }`}
                                            >
                                                {idx + 1}
                                            </button>
                                    ...
                                    <div className={`rounded-2xl border p-7 ${card}`}>
                                        <p className={`text-xs font-medium uppercase tracking-widest mb-3 ${isDark ? "text-blue-500" : "text-blue-600"}`}>
