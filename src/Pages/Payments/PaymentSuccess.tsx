            ...
            >
                <div className={`rounded-2xl border p-10 flex flex-col items-center gap-6 ${
                    ...
                    <button
                        ...
                        className="inline-flex items-center gap-2 px-6 py-2.5 rounded-xl bg-sky-700 hover:bg-sky-600 text-white text-sm font-semibold transition-colors shadow-lg shadow-sky-700/20"
                    >
                        Vai alla Dashboard
                        <ArrowRight size={14} />
                    </button>
