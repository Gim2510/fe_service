            ...
            <input
                ...
                className={`px-4 py-2.5 rounded-xl border outline-none transition text-sm
                    ${error
                        ...
                        : isDark
                            ? "bg-[#111110] border-stone-800/30 text-slate-200 placeholder:text-slate-700 focus:border-sky-700 focus:ring-1 focus:ring-sky-600/20"
                            : "bg-white border-slate-200 text-slate-900 placeholder:text-slate-400 focus:border-sky-600 focus:ring-1 focus:ring-sky-600/15"
                    }
