...
export function NavItemPremium({ to, label, isPremium = false, theme }: Props) {
    const activeBg = theme === "dark"
        ? "bg-gradient-to-r from-indigo-400 via-cyan-400 to-emerald-600 text-black border-transparent shadow-lg shadow-indigo-500/40"
        : "bg-gradient-to-r from-indigo-300 via-cyan-300 to-emerald-500 text-black border-transparent shadow-lg shadow-indigo-400/40";

    const inactiveBg = theme === "dark"
        ? "bg-gradient-to-r from-indigo-500/20 via-cyan-500/20 to-emerald-600/20 text-white border-indigo-500/30 hover:shadow-md hover:shadow-indigo-500/30 hover:scale-[1.03]"
        : "bg-gradient-to-r from-indigo-200/20 via-cyan-200/20 to-emerald-300/20 text-black border-indigo-300/30 hover:shadow-md hover:shadow-indigo-300/30 hover:scale-[1.03]";
    ...
    const normalGlow = theme === "dark"
        ? "bg-gradient-to-r from-indigo-500/10 via-cyan-500/10 to-emerald-600/10"
        : "bg-gradient-to-r from-indigo-200/10 via-cyan-200/10 to-emerald-300/10";
