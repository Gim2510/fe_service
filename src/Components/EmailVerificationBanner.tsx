            ...
            <div className="max-w-7xl mx-auto px-4 py-2.5 flex items-center justify-between gap-4">
                <div className="flex items-center gap-2.5 overflow-hidden">
                    ...
                    <div className="overflow-hidden relative w-full">
                        <p className="animate-scroll whitespace-nowrap text-xs text-sky-400 font-medium">
                ...
                <button
                    ...
                    className="shrink-0 p-1 rounded text-sky-500 hover:text-sky-300 transition-colors"
                    aria-label="Chiudi"
                >
                    <X size={14} />
                </button>
