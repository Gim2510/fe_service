...
function scoreGrade(pct: number): { label: string; color: string; dimColor: string; barColor: string } {
    ...
    if (pct >= 40) return { label: "In sviluppo",  color: "#f59e0b", dimColor: "rgba(245,158,11,0.12)", barColor: "bg-sky-500" };
                            ...
                            <div className="flex gap-2.5">
                                <button
                                    ...
                                    className={`flex-1 inline-flex items-center justify-center gap-1.5 px-4 py-2.5
                                        ...
                                        ${isDark
                                            ? "border-stone-800/40 text-slate-400 hover:text-slate-200 hover:border-sky-800/40"
                                ...
                                <button
                                    ...
                                    className={`flex-1 inline-flex items-center justify-center gap-1.5 px-4 py-2.5
                                        ...
                                        ${consultationBooked
                                            ...
                                            : "bg-sky-700 hover:bg-sky-600 text-white shadow-lg shadow-sky-700/20 hover:-translate-y-0.5"
                                        }`}
                                >
                                    {consultationBooked
