...
export function OverviewPanel({ users, surveys }: any) {
    return (
        <div className="space-y-8">
            <div className="rounded-3xl border border-neutral-700 bg-neutral-900/70 p-6 sm:p-8 backdrop-blur">
                <h2 className="text-2xl mb-4 sm:mb-6">User Distribution</h2>
            ...
            <div className="rounded-3xl border border-neutral-700 bg-neutral-900/70 p-6 sm:p-8 backdrop-blur">
                <h2 className="text-2xl mb-4 sm:mb-6">Survey Trend</h2>
                <div className="space-y-2">
                    {surveys?.responsesByMonth.map((item: any) => (
                        <div key={item.month} className="flex justify-between border-b border-neutral-700 pb-2">
