    ...
    return (
        <div className={`group relative overflow-hidden rounded-2xl border p-7 transition-all duration-300 hover:-translate-y-0.5 cursor-pointer
            ${isDark
                ...
                : "bg-[#F8FAFB] border-slate-200 hover:border-emerald-400 shadow-sm"
            }`}
        >
            ...
            <div className={`absolute bottom-0 left-0 h-[1px] w-0 group-hover:w-full transition-all duration-500 ${isDark ? "bg-emerald-600/30" : "bg-emerald-500/30"}`} />
        </div>
    );
}
