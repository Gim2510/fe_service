...
export function CreateJobApplicationPanel({theme, token,}: {
    ...
    const { createJobApplication, loading, error, success } =
            ...
            <div className={`rounded-3xl border ${cardBg} p-6 sm:p-8 backdrop-blur`}>
                ...
                <form onSubmit={handleSubmit} className="space-y-8">
                    ...
                    <div className="grid sm:grid-cols-4 gap-4">
                        ...
                        <input
                            ...
                            onChange={(e) =>
                                setForm((p) => ({
                                    ...p,
                                    location: { ...p.location, timezone: e.target.value },
                                }))
                            }
                        />
                        ...
                        <select
                            ...
                            onChange={(e) =>
                                setForm((p) => ({
                                    ...
                                    location: {
                                        ...p.location,
                                        remotePolicy: e.target.value as any,
                                    },
                                }))
                            }
                        >
                    ...
                    <label className="flex items-center gap-2 text-sm">
                        <input
                            ...
                            onChange={(e) =>
                                setForm((p) => ({
                                    ...p,
                                    location: { ...p.location, remote: e.target.checked },
                                }))
                            }
                        />
                        Remote position
                    ...
                    <div className="grid sm:grid-cols-2 gap-4">
                        ...
                        <select
                            ...
                            onChange={(e) =>
                                setForm((p) => ({
                                    ...p,
                                    employment: { ...p.employment, type: e.target.value as any },
                                }))
                            }
                        >
                        ...
                        <select
                            ...
                            onChange={(e) =>
                                setForm((p) => ({
                                    ...
                                    employment: {
                                        ...p.employment,
                                        seniority: e.target.value as any,
                                    },
                                }))
                            }
                        >
                    ...
                    <TagInput
                        ...
                        setValues={(v: string[]) =>
                            setForm((p) => ({ ...p, responsibilities: v }))
                        }
                        theme={theme}
                    />
                    ...
                    <TagInput
                        label="Hiring Steps"
                        values={form.hiringProcess?.steps ?? []}
                        setValues={(v: string[]) =>
                            setForm((p) => ({
                                ...p,
                                hiringProcess: { ...p.hiringProcess!, steps: v },
                            }))
                        }
                        theme={theme}
                    />
                    ...
                    <div className="flex items-center gap-4">
                        <LiquidGlassButton type="submit" variant="navbar">
                            Create Job
                        </LiquidGlassButton>
