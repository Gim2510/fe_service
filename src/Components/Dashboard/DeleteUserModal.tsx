...
export function DeleteUserModal({ setShowDeleteUserModal, handleConfirmDeleteUser, loadingDeleteUser}: DeleteUserModalProps) {
    return (
        <>
                    ...
                    <div
                        ...
                        <div className="flex justify-end gap-4">
                            ...
                            <button
                                ...
                                {loadingDeleteUser ? "Deleting..." : "Confirm"}
                            </button>
                        </div>
                    </div>
                </div>
