...
export function ParallaxCTA() {
    ...
    const decY = useTransform(scrollYProgress, [0, 1], [-30, 30]);
    ...
    return (
        <section ref={containerRef} className="relative overflow-hidden">
            ...
            <motion.div
                className="relative mx-auto max-w-4xl px-6 sm:px-8 py-28 sm:py-36 text-center flex flex-col items-center"
            ...
            >
                ...
                >
                    In 10 minuti ottieni un report personalizzato sul livello di maturità digitale della tua azienda.
                </motion.p>
