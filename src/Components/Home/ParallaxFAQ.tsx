...
const faqs = [
    ...
    {
        q: "Chi siete?",
        a: "Due fratelli: uno sviluppatore fullstack con esperienza in startup e come consulente backend/DevOps per progetti enterprise, l'altro specializzato in AI e automazioni complesse. Costruiamo, integriamo, automatizziamo.",
    },
    {
