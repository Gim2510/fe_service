...
// Each card has a unique 3D entry angle
...
function ParallaxCard({ item, index, isDark }: {
    ...
    return (
        ...
        >
            <GlassCard theme={isDark ? "dark" : "light"} className="p-7 h-full">
                <span className={`text-xs font-mono font-medium mb-4 block ${
                    isDark ? "text-sky-600" : "text-sky-500"
                }`}>
    ...
    return (
        <section ref={sectionRef} className="relative overflow-hidden">
            ...
            <div className="relative mx-auto max-w-7xl px-6 sm:px-8 py-20 sm:py-32">
                ...
                {/* Header — parallaxes faster than cards */}
                <motion.div
                ...
                >
                    ...
                    <h2 className={`font-fjalla text-4xl sm:text-5xl font-semibold leading-tight mt-3 ${
                        ...
                        <span className={`block mt-1 ${isDark ? "text-sky-500" : "text-sky-600"}`}>
                ...
                {/* Cards grid — each card has independent 3D parallax */}
                <div
