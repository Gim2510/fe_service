    ...
    return (
        <section className="relative min-h-[100dvh] flex items-center">
            ...
            <div className="relative z-10 mx-auto max-w-7xl sm:px-8 px-4 pb-20 sm:pt-20 pt-28 sm:py-16 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                ...
                {/* LEFT */}
                <div className={` flex flex-col gap-10 p-6 sm:p-0 rounded-2xl sm:bg-transparent ${theme === 'dark' ? 'bg-white/10' : 'bg-white/20'} sm:backdrop-blur-none backdrop-blur-xs border sm:border-none border-white/20 shadow-xl sm:shadow-none`}>
                    <span
